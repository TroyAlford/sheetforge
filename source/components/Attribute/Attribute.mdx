...
<Playground>
  {() => {
    const character = CharacterModel.create({
      attributes: [
        { displayName: 'Strength', value: 4 },
        { displayName: 'Dexterity', value: 3 },
        { displayName: 'Stamina', value: 4 },
        { displayName: 'Charisma', value: 3 },
      ],
      spells: [
        { isActive: true, displayName: 'Bull Strength', effects: [{ target: 'Strength', modifier: 2 }] },
        { isActive: true, displayName: 'Bear Strength', effects: [{ target: 'Strength', modifier: 2 }] },
        { isActive: true, displayName: 'Eagle Splendor', effects: [{ target: 'Charisma', modifier: 2 }] },
        { isActive: true, displayName: 'Curse: Rotting Flesh', effects: [

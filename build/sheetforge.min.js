!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("react"),require("mobx-react"),require("mobx-state-tree")):"function"==typeof define&&define.amd?define("sheetforge",["react","mobx-react","mobx-state-tree"],t):"object"==typeof exports?exports.sheetforge=t(require("react"),require("mobx-react"),require("mobx-state-tree")):e.sheetforge=t(e.react,e["mobx-react"],e["mobx-state-tree"])}("undefined"!=typeof self?self:this,function(e,t,n){return function(e){function t(r){if(n[r])return n[r].exports
...
var r=n(2),a=n(15)
t.autoHash=r.types.optional(r.types.identifier,a.randomHash)},function(e,t,n){"use strict"
...
var o=n(2),i=n(6),u=n(19),l=n(20),c=r(l),s=n(8),d=r(s),f=n(22),p=r(f),m=n(9),y=r(m),v=n(17),h=r(v),b=n(23),g=r(b),E=n(24),_=r(E),O=n(10),j=r(O),w=t.PRIMARY_ATTRIBUTES=["acuity","agility","confidence","devotion","fitness","focus","intellect","intuition","strength"],P=(t.SECONDARY_ATTRIBUTES=["size","naturalArmor"],t.DERIVED_ATTRIBUTES=["body","mind","spirit","potency","reflex","resilience","accuracy","might","toughness","speed","power"],t.DEFAULT_DESCRIPTORS=["age","concept","eyes","gender","hair","height","homeland","race","weight"]),x=function(e){return e.replace(/^./,e.charAt(0).toUpperCase())},N=w.map(function(e){return{id:e,type:"primary",name:x(e),value:-1}}),C=[{id:"size",type:"secondary",name:"Size",value:0},{id:"naturalArmor",type:"secondary",name:"N. Armor",value:0}],A=P.map(function(e){return{id:e,name:x(e),value:""}}),M=o.types.model("Character",{id:i.autoHash,name:"Unnamed Character",rp:0,xp:0,portraitURL:"",primaryAttributes:o.types.optional(o.types.array(c.default),N),secondaryAttributes:o.types.optional(o.types.array(c.default),C),descriptors:o.types.optional(o.types.array(p.default),A),equipment:o.types.optional(o.types.array(o.types.union(d.default,y.default,j.default)),[]),health:o.types.optional(h.default,{}),skills:o.types.optional(o.types.array(g.default),[]),traits:o.types.optional(o.types.array(_.default),[])}).views(function(e){var t=function(t){return(e.attribute(t)||{}).value||0},n=function(){for(var e=arguments.length,n=Array(e),r=0;r<e;r++)n[r]=arguments[r]
...
return{get attributes(){return[].concat(a(e.primaryAttributes),a(e.secondaryAttributes),r)},get attributeIds(){return[].concat(a(e.primaryAttributes.map(function(e){return e.id})),a(r.map(function(e){return e.id})))},get armor(){return e.equipment.filter(function(e){return d.default.is(e)})},get armorRating(){return t("naturalArmor")+(0,u.sum)(e.armor.map(function(e){return e.equipped?e.rating:0}))},get equipped(){return e.equipment.filter(function(e){return e.equipped})},get power(){return(0,u.sum)([].concat(a(e.primaryAttributes.map(function(e){return e.xpCost})),a(e.skills.map(function(e){return e.xpCost})),a(e.traits.map(function(e){return e.xpCost}))))},get weapons(){return e.equipment.filter(function(e){return j.default.is(e)})}}}).actions(function(e){return{addArmor:function(){e.equipment.push(d.default.create())},addItem:function(){e.equipment.push(y.default.create())},addSkill:function(){e.skills.push(g.default.create())},addTrait:function(){e.traits.push(_.default.create())},addWeapon:function(){e.equipment.push(j.default.create())},attribute:function(t){return e.attributes.find(function(e){return e.id===t})},removeItem:function(t){return e.equipment.remove(t)},removeSkill:function(t){return e.skills.remove(t)},removeTrait:function(t){return e.traits.remove(t)},setAttribute:function(t,n){e.attribute(t).setValue(n)},setName:function(t){e.name=t},setPortraitURL:function(t){e.portraitURL=t},setXP:function(t){e.xp=t},setRP:function(t){e.rp=t}}})
...
var a=n(2),o=n(5),i=function(e){return e&&e.__esModule?e:{default:e}}(o),u=t.TYPES=["ok","light","heavy","bane"],l=a.types.enumeration("HealthValue",u,"ok"),c=a.types.model("Health",{levels:a.types.optional(a.types.array(l),[])}).volatile(function(e){return{get parent(){return(0,a.getParent)(e)}}}).views(function(e){return{get damage(){return e.levels.filter(function(e){return"ok"!==e}).length},get max(){var t=e.parent.attribute("resilience").value||0,n=e.parent.attribute("size").value||0
...
var o={}
return"↓"===l&&t<r?o.max=(0,i.default)(a,{min:0}):"↑"===l&&t>r&&(o.min=a),u[(0,i.default)(u.indexOf(e),o)]})}}},afterAttach:function(){(0,a.onSnapshot)(e.parent,function(){return e.resizeValues()}),e.resizeValues(),e.levels.replace(e.levels.slice().sort().reverse())},resizeValues:function(){var t,n=e.max,a=e.levels
...
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},u=n(2),l=n(5),c=r(l),s=n(16),d=r(s),f=n(7),p=r(f),m=u.types.model("Attribute",{id:u.types.identifier,name:u.types.string}).actions(function(e){return{setValue:function(t){var n=(0,c.default)(t,{min:e.min,max:e.max})
n!==e.value&&(e.value=n)}}}),y=u.types.compose(u.types.model("Attribute",{max:10,min:-1,type:u.types.literal("primary"),value:-1}),m,(0,p.default)(function(e){var t=[]
return e.value>=0&&t.push.apply(t,a((0,d.default)(0,e.value))),t.reduce(function(e,t){return e+(0,c.default)(5*t,{min:5})},0)},["setValue"])),v=u.types.compose(u.types.model("Attribute",{type:u.types.literal("secondary"),value:0}),m),h=u.types.model("Attribute",{id:u.types.identifier,name:u.types.string,type:u.types.literal("computed")}),b=function(e){return u.types.compose(h,u.types.model("Attribute",{}).views(function(t){return{get value(){return e(t)}}}))},g=u.types.union(y,v,h,u.types.custom({isTargetType:function(e){return y.is(e)||v.is(e)||h.is(e)},fromSnapshot:function(e){var t=y,n="primary"
return"function"==typeof e.value?(t=b(e.value),n="computed"):["size","naturalArmor"].includes(e.id)&&(t=v,n="secondary"),t.create(i({},e,{type:n}))},toSnapshot:function(e){return e.toJSON()},getValidationMessage:function(e){return"object"===(void 0===e?"undefined":o(e))?"":"${value} is not an object."}}))
t.default=g,t.Primary=y,t.Secondary=v,t.Computed=h,t.createComputed=b},function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
...
Object.defineProperty(t,"__esModule",{value:!0})
var r=n(2),a=r.types.model("Descriptor",{id:r.types.identifier,name:"",value:""}).actions(function(e){return{setName:function(t){e.name=t},setValue:function(t){e.value=t}}})
t.default=a},function(e,t,n){"use strict"
function r(e){return e&&e.__esModule?e:{default:e}}function a(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t]
return n}return Array.from(e)}Object.defineProperty(t,"__esModule",{value:!0})
var o=n(2),i=n(6),u=n(5),l=r(u),c=n(16),s=r(c),d=n(7),f=r(d),p=function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:e
return o.types.optional(o.types.refinement(o.types.number,function(n){return void 0===n||n>=e&&n<=t}),n)},m=o.types.compose(o.types.model("Skill",{id:i.autoHash,name:"New Skill",theory:p(0,10),mastery:p(0,10)}).views(function(e){return{get modifier(){return(0,o.getParent)(e,2).modifierFor(e.name)}}}).actions(function(e){return{remove:function(){return(0,o.getParent)(e,2).removeSkill(e)},setName:function(t){e.name=t},setTheory:function(t){e.theory=t},setMastery:function(t){e.mastery=t}}}),(0,f.default)(function(e){var t=[]
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),d=n(0),f=r(d),p=n(1),m=n(2),y=n(5),v=r(y),h=n(3),b=r(h),g=n(14),E=r(g),_=n(26),O=r(_),j=n(31),w=r(j),P=n(4),x=r(P),N=n(35),C=r(N),A=n(46),M=r(A),S=n(48),T=r(S),R=n(50),k=r(R),q=n(54),D=r(q)
n(58),n(59)
...
function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0})
var a=n(0),o=r(a),i=n(1),u=n(11),l=r(u),c=n(36),s=r(c),d=n(8),f=r(d),p=n(41),m=r(p),y=n(43),v=r(y),h=n(10),b=r(h)
n(45)
var g=function(e){return e.slice().sort((0,l.default)("name")).sort((0,l.default)("equipped",!0))},E={},_=(0,i.observer)(function(e){var t=e.buttons,n=e.equipment,r=void 0===n?[]:n,a=e.layout,i=void 0===a?"large":a,u="large"===i?Math.ceil(r.length/2)+1:r.length+1,l={gridTemplateRows:"repeat("+u+", auto)"}
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function i(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var u,l,c,s=n(0),d=r(s),f=n(1),p=n(12),m=n(3),y=r(m),v=n(13),h=r(v),b=n(8),g=r(b)
n(40)
var E=(0,f.observer)((c=l=function(e){function t(){var e,n,r,i
a(this,t)
for(var u=arguments.length,l=Array(u),c=0;c<u;c++)l[c]=arguments[c]
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function i(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var u,l,c,s=n(0),d=r(s),f=n(1),p=n(12),m=n(13),y=r(m),v=n(3),h=r(v)
n(42)
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function i(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var u,l,c,s=n(0),d=r(s),f=n(1),p=n(12),m=n(3),y=r(m),v=n(13),h=r(v),b=n(10),g=r(b)
n(44)
var E=(0,f.observer)((c=l=function(e){function t(){var e,n,r,i
a(this,t)
for(var u=arguments.length,l=Array(u),c=0;c<u;c++)l[c]=arguments[c]
return n=r=o(this,(e=t.__proto__||Object.getPrototypeOf(t)).call.apply(e,[this].concat(l))),r.renderAlways=function(){var e=r.props,t=e.editing,n=e.item,a=e.onEditEnd,o=e.onEditStart
return d.default.createElement(s.Fragment,null,(0,p.renderEditable)(n,"Equipped",{type:"boolean"}),(0,p.renderEditable)(n,"Name",{className:"icon-weapon",forceEditMode:t,onEditEnd:a,onEditStart:o}),(0,p.renderEditable)(n,"Damage",{type:"number",caption:d.default.createElement("abbr",{title:"Damage"},"Dmg:")}),(0,p.renderEditable)(n,"Range",{type:"number",caption:d.default.createElement("abbr",{title:"Range"},"Rng:")}),(0,p.renderEditable)(n,"Accuracy",{type:"number",caption:d.default.createElement("abbr",{title:"Accuracy"},"Acc:")}))},r.renderExpanded=function(){var e=r.props.item,t=e.description||"Description"
return(0,p.renderEditable)(e,"Description",{placeholder:t})},r.render=function(){return d.default.createElement(h.default,{className:"item-card weapon-card",contentsClassName:"item weapon",renderAlways:r.renderAlways,renderExpanded:r.renderExpanded})},i=n,o(r,i)}return i(t,e),t}(s.Component),l.defaultProps={editing:!1,item:g.default.create(),onEditEnd:y.default,onEditStart:y.default},u=c))||u
t.default=E},function(e,t){},function(e,t){},function(e,t,n){"use strict"
function r(e){return e&&e.__esModule?e:{default:e}}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function i(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var u,l=n(0),c=r(l),s=n(1),d=n(17),f=n(15),p=r(f)
n(47)
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function i(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var u,l=n(0),c=r(l),s=n(1),d=n(11),f=r(d),p=n(51),m=r(p)
n(53)
...
function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0})
var a=n(0),o=r(a),i=n(1),u=n(11),l=r(u),c=n(3),s=r(c),d=n(55),f=r(d)
n(57)
...
return o.default.createElement("div",{className:"traits section",style:c},o.default.createElement("header",null,"Traits",o.default.createElement("button",{className:"icon-add",onClick:n})),o.default.createElement("header",{className:"subheader"},o.default.createElement("div",{className:"trait"},o.default.createElement("span",{className:"name"},"Name"),o.default.createElement("span",{className:"value"},"Cost")),o.default.createElement("div",{className:"trait"},o.default.createElement("span",{className:"name"},"Name"),o.default.createElement("span",{className:"value"},"Cost"))),u.slice().sort(p).map(function(e){return m[e.id]||(m[e.id]=function(){""===e.name&&e.remove()}),o.default.createElement(f.default,{key:e.id,trait:e,onEditEnd:m[e.id]})}))})

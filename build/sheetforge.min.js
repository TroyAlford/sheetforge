...
function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0}),t.createComputed=t.Computed=t.Secondary=t.Primary=void 0
var a=n(2),o=n(5),i=r(o),u=n(14),l=r(u),c=n(7),s=r(c),d=a.types.model("Attribute",{id:a.types.identifier(a.types.string),name:a.types.string}).actions(function(e){return{setValue:function(t){var n=(0,i.default)(t,{min:e.min,max:e.max})
n!==e.value&&(e.value=n)}}}),f=a.types.compose(a.types.model("Attribute",{max:10,min:-1,type:a.types.optional(a.types.literal("primary"),"primary"),value:-1}),d,(0,s.default)(function(e){return(0,l.default)(-1,e.value).reduce(function(e,t){return e+Math.pow(Math.abs(t+1),2)*(t<0?-1:1)},0)},["setValue"])),p=a.types.compose(a.types.model("Attribute",{type:a.types.optional(a.types.literal("secondary"),"secondary"),value:0}),d),m=a.types.model("Attribute",{id:a.types.identifier(a.types.string),name:a.types.string,type:a.types.optional(a.types.literal("computed"),"computed")}),y=function(e){return a.types.compose(m,a.types.model("Attribute",{}).views(function(t){return{get value(){return e(t)}}}))},v=a.types.union(function(e){return"function"==typeof e.value?y(e.value):["size","naturalArmor"].indexOf(e.id)>=0?p:f},f,p,m)
t.default=v,t.Primary=f,t.Secondary=p,t.Computed=m,t.createComputed=y},function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
...
return e.theory>=1&&t.push.apply(t,a((0,s.default)(1,e.theory))),e.mastery>=1&&t.push.apply(t,a((0,s.default)(1,e.mastery))),t.reduce(function(e,t){return e+(0,l.default)(Math.pow(t,2),{min:2})},0)},["setMastery","setTheory"]))
